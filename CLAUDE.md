...
**Published Artifact URL** (as of 2026-08-20): https://claude.ai/code/artifact/69c74289-17b2-4a5e-af17-0fa02a4177d4 — pass this as `url` when republishing an updated build so it updates in place instead of creating a new artifact. Update this line if the user shares a different/newer URL.
